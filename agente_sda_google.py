...
GOOGLE_GEMINI_API_KEY = "AIzaSyA3f-WZXaEdCuTguz1w4cz14nFAjYJwXRs" # CHAVE DE EXEMPLO - SUBSTITUA PELA SUA E EXTERNALIZE!
SPREADSHEET_ID = "12D1AO-WjvSXF0HJQFBJlMs1MCBHDbJEQt3Udd_7CNNU"    # ID da sua Planilha Google
DRIVE_FOLDER_ID = "1Ly8efnxMica8C_3UPXB6aus1_8Cr0-0N"         # ID da Pasta do Google Drive para salvar as imagens
GOOGLE_SERVICE_ACCOUNT_FILE = "senhordosaneis-1bde17264370.json" # Caminho para o arquivo JSON da conta de serviço Google
...
MODELO_GEMINI_PARA_IMAGEM = "gemini-2.0-flash-preview-image-generation" # VERIFIQUE DISPONIBILIDADE!
